# Generated by Django 3.2 on 2024-08-29 18:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+\\Z'), django.core.validators.RegexValidator('[^m][^e]')], verbose_name='Никнейм пользователя')),
                ('email', models.EmailField(max_length=256, unique=True, verbose_name='E-mail пользователя')),
